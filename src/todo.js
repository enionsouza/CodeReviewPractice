...
export default class {
  ...
  addEventListeners() {
    ...
    this.tasks.forEach((task) => {
      ...
      const taskListItem = document.getElementById(`task-${task.index}`);
      dragBtn.addEventListener('mousedown', () => dragTask(taskListItem));
      taskListItem.addEventListener('dragend', () => dropTask(taskListItem));
    });
